...
| Antigravity SessionStart/resume | BUILT on isolated Plan 025 sprint branch; CLI continuity passed on agy 1.2.4, app quit/relaunch/Re-enter pending in `docs/TESTING.md` §51 | — | Codex adapter follow-ups (marker/resume infra, DONE), Antigravity turn-epoch fix (DONE) |
