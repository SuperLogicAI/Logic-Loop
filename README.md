...
| **[Antigravity](https://github.com/google-antigravity/antigravity-cli)** (`agy`) | ✅ | ✅ | Structured hooks, scoped JSONL transcript extraction, and session re-entry via `agy --conversation <id>`. See caveats below. |
