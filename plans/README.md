...
| [025](025-antigravity-session-reentry.md) | Restore Antigravity conversations through session re-entry | P1 | L (live CLI proof + adapter/binding/resume work + macOS pass) | Codex 001/002, Agy 001; real `agy --conversation` continuity proof | BUILT on isolated sprint branch — agy 1.2.4 CLI continuity and automated gates pass; app quit/relaunch/Re-enter still pending (§51), so no acceptance or merge |
