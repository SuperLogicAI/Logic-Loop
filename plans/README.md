...
phase/PR remains one concern. Plan 008 is complete with automated and live
relaunch evidence. Plan 009 is authorized as Phase 30 and built; its live
macOS interaction matrix remains pending.
...
| [009](009-make-window-dragging-repeatable.md) | Make window dragging repeatable from app chrome | P1 | S-M + live macOS matrix | 008 accepted and committed (phase sequencing only) | BUILT — automated gates clean; live macOS matrix pending |
