...
| [030](030-extractor-json-schema.md) | Enforce extractor output with Claude `--json-schema` | P1 | S (one bounded Claude extraction-path hardening) | Explicit maintainer approval; one budgeted golden run | CANDIDATE — planning only. Claude-only structured-output contract; Codex and LM Studio retain the existing parse path. |
