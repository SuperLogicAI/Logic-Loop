...
| [022](022-safe-router-traffic-view.md) | Optional Safe Router model traffic view | P1 | M (read-only reader + compact UI + macOS pass) | Maintainer-authorized bypass of paused Phase 33 testing | BUILT — automated gates clean; macOS live matrix pending; no agent configuration or tag experiment |
